...
public class EventCapture implements WebDriverListener {
    ...
    public void beforeClick(WebElement element) {
        ...
        logger.info( String.format("trying to click on  %s",element));
    }
    ...
    public void afterClick(WebElement element) {
        ...
        logger.info( String.format("clicked on  %s",element));
    ...
    public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
        ...
        logger.info( String.format("trying SendKeys %s to %s",element, Arrays.toString(keysToSend)));
    }

    @Override
    public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
        WebDriverListener.super.afterSendKeys(element, keysToSend);
        logger.info( String.format("sent Keys %s to %s",element, Arrays.toString(keysToSend)));
    }

    @Override
    public void beforeClear(WebElement element) {
        WebDriverListener.super.beforeClear(element);
        logger.info( String.format("trying to clear %s",element));
    }

    @Override
    public void afterClear(WebElement element) {
        WebDriverListener.super.afterClear(element);
        logger.info( String.format("cleared %s",element));
    }
